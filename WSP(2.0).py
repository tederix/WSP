...
page = st.sidebar.selectbox("Выберите параметры", ["p-T", "p-h", "p-s", "h-s", "p-x", "T-x"])
...
if page == "p-T":
    ...
    with col2:
        ...
        st.write("""  """)
        st.write(""" Уд. энтальпия """)
        st.write(""" Уд. энтропия """)
        st.write("""  """)
        st.write(""" Уд. объем """)
        st.write(""" Плотность """)
        st.write(""" Уд. внутренняя энергия """)
        st.write(""" Уд. изобарная теплоемкость """)
        st.write(""" Уд. изохорная теплоемкость """)
